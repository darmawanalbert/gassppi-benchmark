...
e_ranking_list, e_precision_list, e_recall_list, e_auc_roc_list, e_auc_pr_list, e_mcc_list, e_specificity_list, e_npv_list = dbd_all_templates(dbd3_e_list, dbd3_e_templates_5a_dict, verbose=True)
print("\n\n")

print("DBD3: Antibody-Antigen (A)")
a_ranking_list, a_precision_list, a_recall_list, a_auc_roc_list, a_auc_pr_list, a_mcc_list, a_specificity_list, a_npv_list = dbd_all_templates(dbd3_a_list, dbd3_a_templates_5a_dict, verbose=True)
print("\n\n")

print("DBD3: Antigen-Bound Antibody (AB)")
ab_ranking_list, ab_precision_list, ab_recall_list, ab_auc_roc_list, ab_auc_pr_list, ab_mcc_list, ab_specificity_list, ab_npv_list = dbd_all_templates(dbd3_ab_list, dbd3_ab_templates_5a_dict, verbose=True)
print("\n\n")

print("DBD3: Others (O)")
o_ranking_list, o_precision_list, o_recall_list, o_auc_roc_list, o_auc_pr_list, o_mcc_list, o_specificity_list, o_npv_list = dbd_all_templates(dbd3_o_list, dbd3_o_templates_5a_dict, verbose=True)
print("\n\n")

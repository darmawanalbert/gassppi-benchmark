...
masif_path = repository_path + "masif-test/"
...
# MaSIF Test Dataset: Load PPI Templates
masif_test_templates_dict = load_ppi_templates(templates_path, "masif_test_templates.json")
...
print("MaSIF Sanity Test")
_, _, _, _, _, _, _, _ = masif_sanity_test(masif_test_list, masif_test_templates_dict, verbose=True, iteration_per_protein=30)
print("\n\n")

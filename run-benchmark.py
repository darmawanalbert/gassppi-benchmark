...
# Docking Benchmark 5: Load PPI Templates
# Load DBD5 PPI template dictionary from .json files (to be used in the main program)
dbd5_a_templates_dict = load_ppi_templates(templates_path, "dbd5_a_templates.json")
dbd5_ei_templates_dict = load_ppi_templates(templates_path, "dbd5_ei_templates.json")
dbd5_er_templates_dict = load_ppi_templates(templates_path, "dbd5_er_templates.json")
dbd5_es_templates_dict = load_ppi_templates(templates_path, "dbd5_es_templates.json")
dbd5_ab_templates_dict = load_ppi_templates(templates_path, "dbd5_ab_templates.json")
dbd5_og_templates_dict = load_ppi_templates(templates_path, "dbd5_og_templates.json")
dbd5_ox_templates_dict = load_ppi_templates(templates_path, "dbd5_ox_templates.json")
dbd5_or_templates_dict = load_ppi_templates(templates_path, "dbd5_or_templates.json")

dbd5_all_templates_dict = {**dbd5_a_templates_dict, **dbd5_ei_templates_dict, **dbd5_er_templates_dict,
                      **dbd5_es_templates_dict, **dbd5_ab_templates_dict, **dbd5_og_templates_dict,
                      **dbd5_ox_templates_dict, **dbd5_or_templates_dict}
print(len(dbd5_all_templates_dict))

# Docking Benchmark 3: Load PPI Templates
# Load DBD3 PPI template dictionary from .json files (to be used in the main program)
dbd3_e_templates_dict = load_ppi_templates(templates_path, "dbd3_e_templates.json")
dbd3_a_templates_dict = load_ppi_templates(templates_path, "dbd3_a_templates.json")
dbd3_ab_templates_dict = load_ppi_templates(templates_path, "dbd3_ab_templates.json")
dbd3_o_templates_dict = load_ppi_templates(templates_path, "dbd3_o_templates.json")

dbd3_all_templates_dict = {**dbd3_e_templates_dict, **dbd3_a_templates_dict, **dbd3_ab_templates_dict,
                      **dbd3_o_templates_dict}
print(len(dbd3_all_templates_dict))
...
def gass_ppi(input_protein_structure, interface_template, population_size=300, number_of_generations=300, crossover_probability=0.5, mutation_probability=0.7, tournament_size=3, number_of_tournament=50, verbose=False):
    ...
    sasa_threshold = 0.0
    eps = 0.000001
    protein_structure = [residue for residue in input_protein_structure if residue.residue_sasa > sasa_threshold]
...
ei_ranking_list, ei_precision_list, ei_recall_list, ei_auc_roc_list, ei_auc_pr_list, ei_mcc_list, ei_specificity_list, ei_npv_list = dbd_sanity_test(dbd5_ei_list, dbd5_ei_templates_dict, verbose=True, iteration_per_protein=30)
print("\n\n")

print("DBD5: Enzyme-Substrate (ES)")
es_ranking_list, es_precision_list, es_recall_list, es_auc_roc_list, es_auc_pr_list, es_mcc_list, es_specificity_list, es_npv_list = dbd_sanity_test(dbd5_es_list, dbd5_es_templates_dict, verbose=True, iteration_per_protein=30)
print("\n\n")

print("DBD5: Enzyme complex with a regulatory or accessory chain (ER)")
er_ranking_list, er_precision_list, er_recall_list, er_auc_roc_list, er_auc_pr_list, er_mcc_list, er_specificity_list, er_npv_list = dbd_sanity_test(dbd5_er_list, dbd5_er_templates_dict, verbose=True, iteration_per_protein=30)
print("\n\n")

print("DBD5: Antibody-Antigen (A)")
a_ranking_list, a_precision_list, a_recall_list, a_auc_roc_list, a_auc_pr_list, a_mcc_list, a_specificity_list, a_npv_list = dbd_sanity_test(dbd5_a_list, dbd5_a_templates_dict, verbose=True, iteration_per_protein=30)
print("\n\n")

print("DBD5: Antigen-Bound Antibody (AB)")
ab_ranking_list, ab_precision_list, ab_recall_list, ab_auc_roc_list, ab_auc_pr_list, ab_mcc_list, ab_specificity_list, ab_npv_list = dbd_sanity_test(dbd5_ab_list, dbd5_ab_templates_dict, verbose=True, iteration_per_protein=30)
print("\n\n")

print("DBD5: Others, G-protein containing (OG)")
og_ranking_list, og_precision_list, og_recall_list, og_auc_roc_list, og_auc_pr_list, og_mcc_list, og_specificity_list, og_npv_list = dbd_sanity_test(dbd5_og_list, dbd5_og_templates_dict, verbose=True, iteration_per_protein=30)
print("\n\n")

print("DBD5: Others, Receptor containing (OR)")
or_ranking_list, or_precision_list, or_recall_list, or_auc_roc_list, or_auc_pr_list, or_mcc_list, or_specificity_list, or_npv_list = dbd_sanity_test(dbd5_or_list, dbd5_or_templates_dict, verbose=True, iteration_per_protein=30)
print("\n\n")

print("DBD5: Others, miscellaneous (OX)")
ox_ranking_list, ox_precision_list, ox_recall_list, ox_auc_roc_list, ox_auc_pr_list, ox_mcc_list, ox_specificity_list, ox_npv_list = dbd_sanity_test(dbd5_ox_list, dbd5_ox_templates_dict, verbose=True, iteration_per_protein=30)
print("\n\n")
